...
def createTable(tableName,t,org):
  ...
  PRIMARY KEY (`id`)
   ...
   CREATE TABLE IF NOT EXISTS {tableName} (
    ...
    pitch_id INT NOT NULL,
    ground_id INT NOT NULL,
    is_pitch_level BOOLEAN,
    lawn_height DECIMAL(5, 2),
    grass_cover VARCHAR(255),
    min_temp DECIMAL(5, 2),
    max_temp DECIMAL(5, 2),
    forecast TEXT,
    moisture_upto DECIMAL(5, 2),
    machinery_id INT,
    dew_factor DECIMAL(5, 2),
    access_bounce DECIMAL(5, 2),
    remark_by_groundsman TEXT,
    chemical_details_remark TEXT,
    out_no_of_passes INT,
    out_rolling_speed DECIMAL(5, 2),
    out_last_watering_on DATE,
    out_quantity_of_water DECIMAL(5, 2),
    out_time_of_application TIME,
    out_is_daily_watering BOOLEAN,
    out_machinery_id INT,
    out_mowing_done_at_mm DECIMAL(5, 2),
